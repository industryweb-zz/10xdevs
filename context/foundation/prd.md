...
- FR-002: Użytkownik może zalogować się przez email i hasło lub powiązaną tożsamość zewnętrzną. Priority: must-have
...
Wejście: dowolny tekst edukacyjny wklejony przez użytkownika (notatki, fragment skryptu, artykuł). Wyjście: zestaw par pytanie–odpowiedź, gdzie pytanie dotyczy zrozumienia kluczowego pojęcia lub definicji, a odpowiedź to wyjaśnienie wyekstrahowane z tekstu. Użytkownik napotyka wynik reguły na ekranie podglądu fiszek, zanim rozpocznie sesję nauki.

## Access Control

Użytkownik zakłada konto i loguje się przez email i hasło lub powiązaną tożsamość zewnętrzną. Dane fiszek są powiązane z kontem — dostępne po zalogowaniu z dowolnego urządzenia.
...
Brak otwartych pytań — wszystkie kwestie zostały rozstrzygnięte podczas sesji /10x-shape (quality_check_status: accepted).
